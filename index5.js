...
app.use(express.static('public'))
   app.get('/', function(req, res){ res.sendFile(__dirname + '/midipool-ableton.html');
   ...
   app.get('/spectralpool1', function(req, res){res.sendFile(__dirname + '/midipool-ableton.html')});;
