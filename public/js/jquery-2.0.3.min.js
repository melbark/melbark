!function (e, t) {
    ...
    function w(e, t) {
      for (var n, r, i, o = [
      ], s = 0, a = e.length; a > s; s++) r = e[s],
      r.style && (o[s] = me.get(r, 'olddisplay'), n = r.style.display, t ? (o[s] || 'none' !== n || (r.style.display = ''), '' === r.style.display && x(r) && (o[s] = me.access(r, 'olddisplay', k(r.nodeName))))  : o[s] || (i = x(r), (n && 'none' !== n || !i) && me.set(r, 'olddisplay', i ? n : oe.css(r, 'display'))));
      for (s = 0; a > s; s++) r = e[s],
    ...
    function C(e, t, n, r, i) {
      for (var o = n === (r ? 'border' : 'content') ? 4 : 'width' === t ? 1 : 0, s = 0; 4 > o; o += 2) 'margin' === n && (s += oe.css(e, n + Ke[o], !0, i)),
      r ? ('content' === n && (s -= oe.css(e, 'padding' + Ke[o], !0, i)), 'margin' !== n && (s -= oe.css(e, 'border' + Ke[o] + 'Width', !0, i)))  : (s += oe.css(e, 'padding' + Ke[o], !0, i), 'padding' !== n && (s += oe.css(e, 'border' + Ke[o] + 'Width', !0, i)));
      return s
    }
    function N(e, t, n) {
      var r = !0,
    ...
    function k(e) {
      var t = X,
      n = Ge[e];
      return n || (n = E(e, t), 'none' !== n && n || (ze = (ze || oe('<iframe frameborder=\'0\' width=\'0\' height=\'0\'/>').css('cssText', 'display:block !important')).appendTo(t.documentElement), t = (ze[0].contentWindow || ze[0].contentDocument).document, t.write('<!doctype html><html><body>'), t.close(), n = E(e, t), ze.detach()), Ge[e] = n),
      n
    }
    function E(e, t) {
    ...
    function j(e) {
      return function (t, n) {
        ...
        if (oe.isFunction(n)) for (; r = o[i++]; ) '+' === r[0] ? (r = r.slice(1) || '*', (e[r] = e[r] || [
        ]).unshift(n))  : (e[r] = e[r] || [
        ]).push(n)
      }
    }
    ...
    function O(e, t, n) {
      for (var r, i = (Ht[t] || [
      ]).concat(Ht['*']), o = 0, s = i.length; s > o; o++) if (r = i[o].call(n, t, e)) return r
    }
    function F(e, t, n) {
      var r,
      i,
      ...
      c = l.props;
      for (P(c, l.opts.specialEasing); s > o; o++) if (r = qt[o].call(l, e, c, l.opts)) return r;
      return oe.map(c, O, l),
    ...
    function R(e, n, r) {
      ...
      1 === e.nodeType && ('height' in n || 'width' in n) && (r.overflow = [
        ...
        p.overflowX,
        p.overflowY
      ], 'inline' === oe.css(e, 'display') && 'none' === oe.css(e, 'float') && (p.display = 'inline-block')),
      ...
      init: function (e, n, r) {
        ...
        if ('string' == typeof e) {
          if (i = '<' === e.charAt(0) && '>' === e.charAt(e.length - 1) && e.length >= 3 ? [
            ...
            e,
            null
          ] : ue.exec(e), !i || !i[1] && n) return !n || n.jquery ? (n || r).find(e)  : this.constructor(n).find(e);
          if (i[1]) {
    ...
    oe.extend = oe.fn.extend = function () {
      ...
      }, u = 2), 'object' == typeof a || oe.isFunction(a) || (a = {
      }), l === u && (a = this, --u); l > u; u++) if (null != (e = arguments[u])) for (n in e) r = a[n],
      i = e[n],
      a !== i && (c && i && (oe.isPlainObject(i) || (o = oe.isArray(i))) ? (o ? (o = !1, s = r && oe.isArray(r) ? r : [
      ])  : s = r && oe.isPlainObject(r) ? r : {
      }, a[n] = oe.extend(c, s, i))  : i !== t && (a[n] = i));
      return a
    },
    oe.extend({
      ...
      ready: function (e) {
        (e === !0 ? --oe.readyWait : oe.isReady) || (oe.isReady = !0, e !== !0 && --oe.readyWait > 0 || (I.resolveWith(X, [
          oe
        ]), oe.fn.trigger && oe(X).trigger('ready').off('ready')))
      },
      ...
      parseHTML: function (e, t, n) {
        ...
        return r ? [
          t.createElement(r[1])
        ] : (r = oe.buildFragment([e], t, i), i && oe(i).remove(), oe.merge([], r.childNodes))
      },
      ...
      makeArray: function (e, t) {
        ...
        return null != e && (n(Object(e)) ? oe.merge(r, 'string' == typeof e ? [
          e
        ] : e)  : Z.call(r, e)),
        r
      },
    ...
    function (e, t) {
      function n(e, t, n, r) {
        ...
        h,
        g;
        if ((t ? t.ownerDocument || t : $) !== q && L(t), t = t || q, n = n || [
      ...
      function p(e, t) {
        ...
        for (a = e, u = [
          ...
          (!r || (i = fe.exec(a))) && (i && (a = a.slice(i[0].length) || a), u.push(o = [
          ])),
          r = !1,
      ...
      function m(e, t, n, r, i) {
        for (var o, s = [
        ], a = 0, u = e.length, l = null != t; u > a; a++) (o = e[a]) && (!n || n(o, r, i)) && (s.push(o), l && t.push(a));
        return s
      }
      function y(e, t, n, r, o, s) {
        ...
        i(function (i, s, a, u) {
          ...
          if (n && n(y, v, a, u), r) for (l = m(v, d), r(l, [
          ], a, u), c = l.length; c--; ) (f = l[c]) && (v[d[c]] = !(y[d[c]] = f));
          if (i) {
            if (o || e) {
              if (o) {
                for (l = [
                ], c = v.length; c--; ) (f = v[c]) && l.push(y[c] = f);
                o(null, v = [
                ], l, u)
              }
      ...
      function v(e) {
        ...
        ]; i > a; a++) if (n = k.relative[e[a].type]) c = [
          h(g(c), n)
        ];
         else {
      ...
      function x(e, t) {
        ...
        a = function (i, a, u, l, c) {
          ...
          if (g += y, o && y !== g) {
            ...
            ee.apply(l, h),
            x && !i && h.length > 0 && g + t.length > 1 && n.uniqueSort(l)
          }
          return x && (B = T, D = b),
          v
        };
      ...
      function w(e, t, n, r) {
        ...
        if (!r && 1 === l.length) {
          if (o = l[0] = l[0].slice(0), o.length > 2 && 'ID' === (s = o[0]).type && C.getById && 9 === t.nodeType && O && k.relative[o[1].type]) {
            if (t = (k.find.ID(s.matches[0].replace(Ce, Ne), t) || [
            ]) [0], !t) return n;
            e = e.slice(o.shift().value.length)
          }
          for (i = ye.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !k.relative[a = s.type]); ) if ((u = k.find[a]) && (r = u(s.matches[0].replace(Ce, Ne), de.test(o[0].type) && t.parentNode || t))) {
            if (o.splice(i, 1), e = r.length && d(o), !e) return ee.apply(n, r),
            n;
            break
          }
        }
        return j(e, l) (r, t, !O, n, de.test(e)),
        n
      }
      var T,
      C,
      ...
      try {
        ee.apply(Q = te.call($.childNodes), $.childNodes),
      ...
      L = n.setDocument = function (e) {
        ...
        ], (C.qsa = ve.test(n.querySelectorAll)) && (o(function (e) {
      ...
      k = n.selectors = {
        ...
        filter: {
             ...
             : function (t, n, u) {
              ...
              if (m) {
                ...
                if (h = [
                  ...
                  ], d = l[0] === B && l[1], p = l[0] === B && l[2], f = d && m.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop(); ) if (1 === f.nodeType && ++p && f === t) {
                    c[e] = [
                      B,
                      d,
                      p
                 ...
                 else for (; (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== y : 1 !== f.nodeType) || !++p || (v && ((f[W] || (f[W] = {
                })) [e] = [
                  B,
                  p
                ]), f !== t)); );
          ...
          PSEUDO: function (e, t) {
            var r,
            o = k.pseudos[e] || k.setFilters[e.toLowerCase()] || n.error('unsupported pseudo: ' + e);
            return o[W] ? o(t)  : o.length > 1 ? (r = [
              e,
              e,
              '',
              t
      ...
      p = {
        ...
        remove: function () {
          return l && oe.each(arguments, function (e, t) {
            for (var n; (n = oe.inArray(t, l, n)) > - 1; ) l.splice(n, 1),
            o && (a >= n && a--, u >= n && u--)
          }),
          this
        },
    ...
    oe.extend({
            ...
            return oe.Deferred(function (n) {
              oe.each(t, function (t, o) {
                ...
                i[o[1]](function () {
                  ...
                  e && oe.isFunction(e.promise) ? e.promise().done(n.resolve).fail(n.reject).progress(n.notify)  : n[s + 'With'](this === r ? n.promise()  : this, a ? [
                    e
                  ] : arguments)
                })
              }),
      ...
      when: function (e) {
        ...
        if (s > 1) for (t = Array(s), n = Array(s), r = Array(s); s > i; i++) o[i] && oe.isFunction(o[i].promise) ? o[i].promise().done(l(i, r, o)).fail(u.reject).progress(l(i, n, t))  : --a;
      ...
      return n.type ? (n.type = 'checkbox', t.checkOn = '' !== n.value, t.optSelected = s.selected, t.reliableMarginRight = !0, t.boxSizingReliable = !0, t.pixelPosition = !1, n.checked = !0, t.noCloneChecked = n.cloneNode(!0).checked, o.disabled = !0, t.optDisabled = !s.disabled, n = X.createElement('input'), n.value = 't', n.type = 'radio', t.radioValue = 't' === n.value, n.setAttribute('checked', 't'), n.setAttribute('name', 't'), r.appendChild(n), t.checkClone = r.cloneNode(!0).cloneNode(!0).lastChild.checked, t.focusinBubbles = 'onfocusin' in e, i.style.backgroundClip = 'content-box', i.cloneNode(!0).style.backgroundClip = '', t.clearCloneStyle = 'content-box' === i.style.backgroundClip, oe(function () {
        ...
        s && (n = X.createElement('div'), n.style.cssText = 'border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px', s.appendChild(n).appendChild(i), i.innerHTML = '', i.style.cssText = '-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%', oe.swap(s, null != s.style.zoom ? {
         ...
         : {
          ...
          width: '4px'
        }).width, r = i.appendChild(X.createElement('div')), r.style.cssText = i.style.cssText = o, r.style.marginRight = r.style.width = '0', i.style.width = '1px', t.reliableMarginRight = !parseFloat((e.getComputedStyle(r, null) || {
        }).marginRight)), s.removeChild(n))
      }), t)  : t
    }({
    });
    var ge,
    ...
    i.prototype = {
      ...
      remove: function (e, n) {
        ...
        if (n === t) this.cache[s] = {
          ...
          oe.isArray(n) ? i = n.concat(n.map(oe.camelCase))  : (o = oe.camelCase(n), n in a ? i = [
            n,
            o
          ] : (i = o, i = i in a ? [
            i
    ...
    oe.extend({
      queue: function (e, n, r) {
        var i;
        return e ? (n = (n || 'fx') + 'queue', i = me.get(e, n), r && (!i || oe.isArray(r) ? i = me.access(e, n, oe.makeArray(r))  : i.push(r)), i || [
        ])  : t
      },
    ...
    oe.fn.extend({
      queue: function (e, n) {
        ...
        r > arguments.length ? oe.queue(this[0], e)  : n === t ? this : this.each(function () {
    ...
    oe.fn.extend({
      ...
      addClass: function (e) {
        ...
        if (u) for (t = (e || '').match(ae) || [
        ]; a > s; s++) if (n = this[s], r = 1 === n.nodeType && (n.className ? (' ' + n.className + ' ').replace(we, ' ')  : ' ')) {
      ...
      toggleClass: function (e, t) {
        ...
        return 'boolean' == typeof t && 'string' === n ? t ? this.addClass(e)  : this.removeClass(e)  : oe.isFunction(e) ? this.each(function (n) {
          ...
          if ('string' === n) for (var t, r = 0, i = oe(this), o = e.match(ae) || [
    ...
    oe.extend({
      valHooks: {
        ...
        select: {
          get: function (e) {
            for (var t, n, r = e.options, i = e.selectedIndex, o = 'select-one' === e.type || 0 > i, s = o ? null : [
            ], a = o ? i + 1 : r.length, u = 0 > i ? a : o ? i : 0; a > u; u++) if (n = r[u], !(!n.selected && u !== i || (oe.support.optDisabled ? n.disabled : null !== n.getAttribute('disabled')) || n.parentNode.disabled && oe.nodeName(n.parentNode, 'optgroup'))) {
          ...
          set: function (e, t) {
            for (var n, r, i = e.options, o = oe.makeArray(t), s = i.length; s--; ) r = i[s],
      ...
      attr: function (e, n, r) {
        ...
        o,
        s = e.nodeType;
        return e && 3 !== s && 8 !== s && 2 !== s ? typeof e.getAttribute === z ? oe.prop(e, n, r)  : (1 === s && oe.isXMLDoc(e) || (n = n.toLowerCase(), i = oe.attrHooks[n] || (oe.expr.match.bool.test(n) ? be : xe)), r === t ? i && 'get' in i && null !== (o = i.get(e, n)) ? o : (o = oe.find.attr(e, n), null == o ? t : o)  : null !== r ? i && 'set' in i && (o = i.set(e, r, n)) !== t ? o : (e.setAttribute(n, r + ''), r)  : (oe.removeAttr(e, n), t))  : void 0
      },
      ...
      prop: function (e, n, r) {
        ...
        s,
        a = e.nodeType;
        return e && 3 !== a && 8 !== a && 2 !== a ? (s = 1 !== a || !oe.isXMLDoc(e), s && (n = oe.propFix[n] || n, o = oe.propHooks[n]), r !== t ? o && 'set' in o && (i = o.set(e, r, n)) !== t ? i : e[n] = r : o && 'get' in o && null !== (i = o.get(e, n)) ? i : e[n])  : void 0
      },
      propHooks: {
        tabIndex: {
          get: function (e) {
    ...
    oe.event = {
      ...
      add: function (e, n, r, i, o) {
        ...
        y = me.get(e);
        if (y) {
          for (r.handler && (s = r, r = s.handler, o = s.selector), r.guid || (r.guid = oe.guid++), (l = y.events) || (l = y.events = {
          }), (a = y.handle) || (a = y.handle = function (e) {
            return typeof oe === z || e && oe.event.triggered === e.type ? t : oe.event.dispatch.apply(a.elem, arguments)
          }, a.elem = e), n = (n || '').match(ae) || [
            ''
          ], c = n.length; c--; ) u = Se.exec(n[c]) || [
          ],
          h = m = u[1],
          g = (u[2] || '').split('.').sort(),
          ...
          ], d.delegateCount = 0, p.setup && p.setup.call(e, i, g, a) !== !1 || e.addEventListener && e.addEventListener(h, a, !1)), p.add && (p.add.call(e, f), f.handler.guid || (f.handler.guid = r.guid)), o ? d.splice(d.delegateCount++, 0, f)  : d.push(f), oe.event.global[h] = !0);
          e = null
        }
      },
      remove: function (e, t, n, r, i) {
        ...
        if (m && (u = m.events)) {
          for (t = (t || '').match(ae) || [
            ''
          ], l = t.length; l--; ) if (a = Se.exec(t[l]) || [
          ], d = g = a[1], h = (a[2] || '').split('.').sort(), d) {
            for (f = oe.event.special[d] || {
            }, d = (r ? f.delegateType : f.bindType) || d, p = u[d] || [
            ], a = a[2] && RegExp('(^|\\.)' + h.join('\\.(?:.*\\.|)') + '(\\.|$)'), s = o = p.length; o--; ) c = p[o],
      ...
      trigger: function (n, r, i, o) {
        ...
        if (a = u = i = i || X, 3 !== i.nodeType && 8 !== i.nodeType && !Ee.test(h + oe.event.triggered) && (h.indexOf('.') >= 0 && (g = h.split('.'), h = g.shift(), g.sort()), c = 0 > h.indexOf(':') && 'on' + h, n = n[oe.expando] ? n : new oe.Event(h, 'object' == typeof n && n), n.isTrigger = o ? 2 : 3, n.namespace = g.join('.'), n.namespace_re = n.namespace ? RegExp('(^|\\.)' + g.join('\\.(?:.*\\.|)') + '(\\.|$)')  : null, n.result = t, n.target || (n.target = i), r = null == r ? [
          n
        ] : oe.makeArray(r, [
          n
          ...
          if (!o && !p.noBubble && !oe.isWindow(i)) {
            for (l = p.delegateType || h, Ee.test(l + h) || (a = a.parentNode); a; a = a.parentNode) d.push(a),
            u = a;
            u === (i.ownerDocument || X) && d.push(u.defaultView || u.parentWindow || e)
          }
          for (s = 0; (a = d[s++]) && !n.isPropagationStopped(); ) n.type = s > 1 ? l : p.bindType || h,
          f = (me.get(a, 'events') || {
          }) [n.type] && me.get(a, 'handle'),
          f && f.apply(a, r),
          f = c && a[c],
          f && oe.acceptData(a) && f.apply && f.apply(a, r) === !1 && n.preventDefault();
          return n.type = h,
          o || n.isDefaultPrevented() || p._default && p._default.apply(d.pop(), r) !== !1 || !oe.acceptData(i) || c && oe.isFunction(i[h]) && !oe.isWindow(i) && (u = i[c], u && (i[c] = null), oe.event.triggered = h, i[h](), oe.event.triggered = t, u && (i[c] = u)),
          n.result
        }
      },
      dispatch: function (e) {
        ...
        u = ee.call(arguments),
        l = (me.get(this, 'events') || {
        }) [e.type] || [
        ],
        c = oe.event.special[e.type] || {
        };
        if (u[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
          for (a = oe.event.handlers.call(this, e, l), n = 0; (o = a[n++]) && !e.isPropagationStopped(); ) for (e.currentTarget = o.elem, r = 0; (s = o.handlers[r++]) && !e.isImmediatePropagationStopped(); ) (!e.namespace_re || e.namespace_re.test(s.namespace)) && (e.handleObj = s, e.data = s.data, i = ((oe.event.special[s.origType] || {
          }).handle || s.handler).apply(o.elem, u), i !== t && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
      ...
      handlers: function (e, n) {
        ...
        if (u && l.nodeType && (!e.button || 'click' !== e.type)) for (; l !== this; l = l.parentNode || this) if (l.disabled !== !0 || 'click' !== e.type) {
          ...
          o = s.selector + ' ',
          i[o] === t && (i[o] = s.needsContext ? oe(o, this).index(l) >= 0 : oe.find(o, this, null, [
            l
          ]).length),
          i[o] && i.push(s);
          i.length && a.push({
      ...
      fix: function (e) {
        ...
        o = e,
        s = this.fixHooks[i];
        for (s || (this.fixHooks[i] = s = ke.test(i) ? this.mouseHooks : Ne.test(i) ? this.keyHooks : {
        }), r = s.props ? this.props.concat(s.props)  : this.props, e = new oe.Event(o), t = r.length; t--; ) n = r[t],
        e[n] = o[n];
    ...
    oe.fn.extend({
      ...
      is: function (e) {
        return !!c(this, 'string' == typeof e && Ae.test(e) ? oe(e)  : e || [
        ], !1).length
      },
      closest: function (e, t) {
        for (var n, r = 0, i = this.length, o = [
        ], s = Ae.test(e) || 'string' != typeof e ? oe(e, t || this.context)  : 0; i > r; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (11 > n.nodeType && (s ? s.index(n) > - 1 : 1 === n.nodeType && oe.find.matchesSelector(n, e))) {
          n = o.push(n);
          break
        }
      ...
      add: function (e, t) {
        var n = 'string' == typeof e ? oe(e, t)  : oe.makeArray(e && e.nodeType ? [
          e
        ] : e),
    ...
    oe.each({
      ...
      oe.fn[e] = function (n, r) {
        ...
        this.length > 1 && (Le[e] || oe.unique(i), De.test(e) && i.reverse()),
        this.pushStack(i)
      }
    }),
    oe.extend({
      filter: function (e, t, n) {
        var r = t[0];
        return n && (e = ':not(' + e + ')'),
        1 === t.length && 1 === r.nodeType ? oe.find.matchesSelector(r, e) ? [
          r
        ] : [
      ...
      dir: function (e, n, r) {
        for (var i = [
        ], o = r !== t; (e = e[n]) && 9 !== e.nodeType; ) if (1 === e.nodeType) {
    ...
    oe.fn.extend({
      ...
      html: function (e) {
        return oe.access(this, function (e) {
          ...
          if ('string' == typeof e && !Fe.test(e) && !Be[(He.exec(e) || [
            '',
            ''
          ]) [1].toLowerCase()]) {
            e = e.replace(qe, '<$1></$2>');
      ...
      domManip: function (e, t, n) {
        ...
        if (c && (r = oe.buildFragment(e, this[0].ownerDocument, !1, !n && this), i = r.firstChild, 1 === r.childNodes.length && (r = i), i)) {
          for (o = oe.map(m(r, 'script'), p), s = o.length; c > l; l++) a = r,
          l !== h && (a = oe.clone(a, !0, !0), s && oe.merge(o, m(a, 'script'))),
          t.call(this[l], a, l);
          if (s) for (u = o[o.length - 1].ownerDocument, oe.map(o, d), l = 0; s > l; l++) a = o[l],
    ...
    oe.each({
      ...
      oe.fn[e] = function (e) {
        for (var n, r = [
        ], i = oe(e), o = i.length - 1, s = 0; o >= s; s++) n = s === o ? this : this.clone(!0),
        oe(i[s]) [t](n),
        Z.apply(r, n.get());
    ...
    oe.extend({
      ...
      buildFragment: function (e, t, n, r) {
        for (var i, o, s, a, u, l, c = 0, f = e.length, p = t.createDocumentFragment(), d = [
        ]; f > c; c++) if (i = e[c], i || 0 === i) if ('object' === oe.type(i)) oe.merge(d, i.nodeType ? [
          i
        ] : i);
         else if (Oe.test(i)) {
          for (o = o || p.appendChild(t.createElement('div')), s = (He.exec(i) || [
            '',
            ''
          ]) [1].toLowerCase(), a = Be[s] || Be._default, o.innerHTML = a[1] + i.replace(qe, '<$1></$2>') + a[2], l = a[0]; l--; ) o = o.lastChild;
      ...
      cleanData: function (e) {
        for (var n, r, o, s, a, u, l = oe.event.special, c = 0; (r = e[c]) !== t; c++) {
          if (i.accepts(r) && (a = r[me.expando], a && (n = me.cache[a]))) {
            if (o = Object.keys(n.events || {
            }), o.length) for (u = 0; (s = o[u]) !== t; u++) l[s] ? oe.event.remove(r, s)  : oe.removeEvent(r, s, n.handle);
    ...
    oe.extend({
      ...
      style: function (e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          ...
          u = oe.camelCase(n),
          l = e.style;
          return n = oe.cssProps[u] || (oe.cssProps[u] = v(l, u)),
          a = oe.cssHooks[n] || oe.cssHooks[u],
          r === t ? a && 'get' in a && (o = a.get(e, !1, i)) !== t ? o : l[n] : (s = typeof r, 'string' === s && (o = Ve.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(oe.css(e, n)), s = 'number'), null == r || 'number' === s && isNaN(r) || ('number' !== s || oe.cssNumber[u] || (r += 'px'), oe.support.clearCloneStyle || '' !== r || 0 !== n.indexOf('background') || (l[n] = 'inherit'), a && 'set' in a && (r = a.set(e, r, i)) === t || (l[n] = r)), t)
        }
      },
    ...
    Ie = function (e, n, r) {
      ...
      l = e.style;
      return a && ('' !== u || oe.contains(e.ownerDocument, e) || (u = oe.style(e, n)), Ye.test(u) && Xe.test(n) && (i = l.width, o = l.minWidth, s = l.maxWidth, l.minWidth = l.maxWidth = l.width = u, u = a.width, l.width = i, l.minWidth = o, l.maxWidth = s)),
      u
    },
    oe.each(['height',
    'width'], function (e, n) {
    ...
    oe(function () {
      ...
      !oe.support.pixelPosition && oe.fn.position && oe.each(['top',
      'left'], function (e, n) {
        oe.cssHooks[n] = {
          get: function (e, r) {
      ...
      oe.cssHooks[e + t] = {
        expand: function (n) {
          for (var r = 0, i = {
            ...
            n
          ]; 4 > r; r++) i[e + Ke[r] + t] = o[r] || o[r - 2] || o[0];
          return i
        }
      },
      ...
      ajax: function (e, n) {
        function r(e, n, r, a) {
          ...
          2 !== b && (b = 2, u && clearTimeout(u), i = t, s = a || '', T.readyState = e > 0 ? 4 : 0, l = e >= 200 && 300 > e || 304 === e, r && (x = L(p, T, r)), x = q(p, x, T, l), l ? (p.ifModified && (w = T.getResponseHeader('Last-Modified'), w && (oe.lastModified[o] = w), w = T.getResponseHeader('etag'), w && (oe.etag[o] = w)), 204 === e || 'HEAD' === p.type ? C = 'nocontent' : 304 === e ? C = 'notmodified' : (C = x.state, f = x.data, v = x.error, l = !v))  : (v = C, (e || !C) && (C = 'error', 0 > e && (e = 0))), T.status = e, T.statusText = (n || C) + '', l ? g.resolveWith(d, [
            ...
            C,
            v
          ]), T.statusCode(y), y = t, c && h.trigger(l ? 'ajaxSuccess' : 'ajaxError', [
            T,
            p,
            l ? f : v
          ]), m.fireWith(d, [
        ...
        T = {
          ...
          getResponseHeader: function (e) {
            ...
            if (2 === b) {
              if (!a) for (a = {
              }; t = ft.exec(s); ) a[t[1].toLowerCase()] = t[2];
              t = a[e.toLowerCase()]
            }
        ...
        if (g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || st) + '').replace(lt, '').replace(ht, ot[1] + '//'), p.type = n.method || n.type || p.method || p.type, p.dataTypes = oe.trim(p.dataType || '*').toLowerCase().match(ae) || [
          ''
        ], null == p.crossDomain && (l = gt.exec(p.url.toLowerCase()), p.crossDomain = !(!l || l[1] === ot[1] && l[2] === ot[2] && (l[3] || ('http:' === l[1] ? '80' : '443')) === (ot[3] || ('http:' === ot[1] ? '80' : '443')))), p.data && p.processData && 'string' != typeof p.data && (p.data = oe.param(p.data, p.traditional)), D(yt, p, n, T), 2 === b) return T;
        c = p.global,
        c && 0 === oe.active++ && oe.event.trigger('ajaxStart'),
        p.type = p.type.toUpperCase(),
        p.hasContent = !dt.test(p.type),
        o = p.url,
        p.hasContent || (p.data && (o = p.url += (ut.test(o) ? '&' : '?') + p.data, delete p.data), p.cache === !1 && (p.url = ct.test(o) ? o.replace(ct, '$1_=' + at++)  : o + (ut.test(o) ? '&' : '?') + '_=' + at++)),
    ...
    oe.ajaxPrefilter('json jsonp', function (n, r, i) {
      ...
      s,
      a,
      u = n.jsonp !== !1 && (Tt.test(n.url) ? 'url' : 'string' == typeof n.data && !(n.contentType || '').indexOf('application/x-www-form-urlencoded') && Tt.test(n.data) && 'data');
    ...
    oe.fn.extend({
      ...
      stop: function (e, n, r) {
        ...
        this.each(function () {
          ...
          if (n) s[n] && s[n].stop && i(s[n]);
           else for (n in s) s[n] && s[n].stop && Lt.test(n) && i(s[n]);
      ...
      finish: function (e) {
        ...
        this.each(function () {
          ...
          o = oe.timers,
          s = r ? r.length : 0;
          for (n.finish = !0, oe.queue(this, e, [
    ...
    oe.fx.tick = function () {
      ...
      n = oe.timers,
      r = 0;
      for (St = oe.now(); n.length > r; r++) e = n[r],
